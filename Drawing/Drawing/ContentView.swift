...
struct Spirograph: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        let divisor = gcd(self.innerRadius, self.outerRadius)
...
//        }
//        set {
//            let last = newValue.second.second.second.second
//        }
//    }
...
//            .onTapGesture {
//                withAnimation {
//                    self.thickness = CGFloat.random(in: 0...20)
//                }
//            }
//
//            Slider(value: $thickness, in: 0...20, step: 1)
